...
```{r results= "asis"}
Geo=gvisGeoChart(bcities, "latlong", colorvar = "Rank", options = list(region="US", dataMode= "markers",resolution= "provinces", width= 800, height=800, sizeAxis = '{minValue: 1,  maxSize: 3}'))
Geo
```
